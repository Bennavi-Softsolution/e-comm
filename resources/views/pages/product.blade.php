      ...
      <aside class="col-lg-6">
        <div class="border rounded-4 mb-3 d-flex justify-content-center">
          <a data-fslightbox="mygalley" class="rounded-4" target="_blank" data-type="image" >
            <img style="max-width: 100%; max-height: 50vh; margin: auto;" class="rounded-4 fit" src="/images/capsicum-1.png" />
          </a>
        </div>
      ...
      <main class="col-lg-6">
        <div class="ps-lg-3">
          ...
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed 
            ...
            urna urna iaculis magna, sit amet posuere nunc libero eu eros. Aenean nec scelerisque urna, at condimentum urna.Suspendisse vitae orci et elit facilisis faucibus. Donec ac sodales turpis. Morbi in ipsum quis enim venenatis congue
