...
.custom-input {
        ...
        .custom-input::placeholder {
            color: #333; /* Dark grey placeholder text */
...
<div class="card">
        <div class="card-body">
            <div class="container py-4">
                <div class="p-4">
                    <input type="text" placeholder="First Name" class="form-control custom-input placeholder-white mb-3" />
                    <input type="text" placeholder="Last Name" class="form-control custom-input placeholder-white mb-3" />
                    ...
                    <input type="text" placeholder="Address" class="form-control custom-input placeholder-white mb-3" />
                    <input type="text" placeholder="Additional information" class="form-control custom-input placeholder-white mb-3" />
